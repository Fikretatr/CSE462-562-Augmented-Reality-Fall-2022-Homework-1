...
public class hww : MonoBehaviour
{
    float x1, y1, z1;
    ...
    {
        //Debug.Log("fikret");
        FileInfo theSourceFile = new FileInfo(@"C:\Users\atarf\Desktop\arodev2\file1.txt");
           ...
           // Console.WriteLine(text);
            ...
            foreach (var word in words)
            {
                ...
                if (flag == 1)
                {
                    ...
                    sphere.GetComponent<Renderer>().material.color = new Color32(0, 47, 58, 90);
